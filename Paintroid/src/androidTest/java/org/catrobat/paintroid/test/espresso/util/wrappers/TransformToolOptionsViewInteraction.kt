...
class TransformToolOptionsViewInteraction private constructor() : CustomViewInteraction(Espresso.onView(withId(R.id.pocketpaint_layout_tool_options))) {
    ...
    fun performFlipHorizontal(): TransformToolOptionsViewInteraction {
        Espresso.onView(withId(R.id.pocketpaint_transform_flip_horizontal_btn))
                .perform(ViewActions.click())
        return this
    }
    ...
    fun checkPercentageTextMatches(expected: Int): TransformToolOptionsViewInteraction {
        Espresso.onView(withId(R.id.pocketpaint_transform_resize_percentage_text))
                .check(ViewAssertions.matches(ViewMatchers.withText(Integer.toString(expected))))
        return this
    }
    ...
    fun checkIsDisplayed(): TransformToolOptionsViewInteraction {
