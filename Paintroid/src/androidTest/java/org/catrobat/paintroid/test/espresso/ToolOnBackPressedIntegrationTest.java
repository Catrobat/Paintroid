...
public class ToolOnBackPressedIntegrationTest {
	...
	public void setUp() {
		...
		currentTool = launchActivityRule.getActivity().currentTool;
	}
	...
	public void testNotBrushToolBackPressed() {
		...
		assertEquals(currentTool.get().getToolType(), ToolType.BRUSH);
	}
	...
	public void testToolOptionsDisappearWhenBackPressed() {
		...
		assertEquals(currentTool.get().getToolType(), ToolType.CURSOR);
