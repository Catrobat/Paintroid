...
class ScreenshotOnFailRule : TestWatcher() {
    private val uiAutomation = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR2) InstrumentationRegistry.getInstrumentation().uiAutomation else null
    override fun failed(e: Throwable, description: Description) {
        ...
        val path = File(ApplicationProvider.getApplicationContext<Context>().getExternalFilesDir(null), "/screenshots/")
