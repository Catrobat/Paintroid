...
import org.catrobat.paintroid.test.espresso.util.wrappers.TransformToolOptionsViewInteraction2
...
class LayerIntegrationTest {
    ...
    fun testResizingThroughAllLayers() {
        ...
        TransformToolOptionsViewInteraction2.onTransformToolOptionsView()
            .performAutoCrop()
        TopBarViewInteraction.onTopBarView()
