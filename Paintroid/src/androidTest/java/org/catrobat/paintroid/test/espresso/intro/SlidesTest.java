...
public class SlidesTest {
	...
	public void testWelcomeSlide() {
		...
		IntroUtils.checkViewMatchesText(R.id.pocketpaint_intro_welcome_head, R.string.welcome_to_pocket_paint);
		IntroUtils.checkViewMatchesText(R.id.pocketpaint_intro_welcome_text, R.string.intro_welcome_text);
	}
	...
	public void testPossibilitiesSlide() {
		...
		IntroUtils.checkViewMatchesText(R.id.pocketpaint_intro_possibilities_head, R.string.more_possibilities);
		IntroUtils.checkViewMatchesText(R.id.pocketpaint_intro_possibilities_text, R.string.intro_possibilities_text);
	}
	...
	public void testLandscapeSlide() {
		...
		IntroUtils.checkViewMatchesText(R.id.pocketpaint_intro_landscape_head, R.string.landscape);
		IntroUtils.checkViewMatchesText(R.id.pocketpaint_intro_landscape_text, R.string.intro_landscape_text);
	...
	@Test
	public void testGetStartedSlide() {
		IntroUtils.changeIntroPage(getPageIndexFromLayout(activityRule.getLayouts(), R.layout.pocketpaint_slide_intro_getstarted));
		IntroUtils.checkViewMatchesText(R.id.pocketpaint_intro_started_head, R.string.enjoy_pocket_paint);
		IntroUtils.checkViewMatchesText(R.id.pocketpaint_intro_started_text, R.string.intro_get_started);
