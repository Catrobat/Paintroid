...
public class BaseToolWithRectangleShapeTest {
	...
	public void setUp() {
		...
		toolToTest = new BaseToolWithRectangleShapeImpl(contextCallback, toolOptionsController, ToolType.BRUSH, toolPaint, workspace, commandManager, commandFactory);
	...
	public void testRectangleSizeMaximumWhenZoomed() {
		...
		toolToTest = new BaseToolWithRectangleShapeImpl(contextCallback, toolOptionsController, ToolType.SHAPE,
				toolPaint, workspace, commandManager, commandFactory);
	...
	private class BaseToolWithRectangleShapeImpl extends BaseToolWithRectangleShape {
		...
		BaseToolWithRectangleShapeImpl(ContextCallback contextCallback, ToolOptionsControllerContract toolOptionsController, ToolType toolType, ToolPaint toolPaint,
				Workspace layerModelWrapper, CommandManager commandManager, CommandFactory commandFactory) {
			super(contextCallback, toolOptionsController, toolPaint, layerModelWrapper, commandManager, commandFactory);
