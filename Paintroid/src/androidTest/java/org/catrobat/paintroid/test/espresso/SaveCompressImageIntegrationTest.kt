...
class SaveCompressImageIntegrationTest {
    ...
    fun testSaveImage() {
        ...
        Espresso.onView(ViewMatchers.withId(R.id.pocketpaint_image_name_save_text)).perform(ViewActions.replaceText(testName))
        ...
        val compressedBitmap = Objects.requireNonNull(activity.model.savedPictureUri
