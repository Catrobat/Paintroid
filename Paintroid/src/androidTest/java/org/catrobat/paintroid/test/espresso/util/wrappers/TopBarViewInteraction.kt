...
class TopBarViewInteraction private constructor() :
    ...
    fun onUndoButton(): ViewInteraction = Espresso.onView(ViewMatchers.withId(R.id.pocketpaint_btn_top_undo))

    fun onRedoButton(): ViewInteraction = Espresso.onView(ViewMatchers.withId(R.id.pocketpaint_btn_top_redo))

    fun onCheckmarkButton(): ViewInteraction = Espresso.onView(ViewMatchers.withId(R.id.pocketpaint_btn_top_checkmark))

    private fun onPlusButton(): ViewInteraction = Espresso.onView(ViewMatchers.withId(R.id.pocketpaint_btn_top_plus))
