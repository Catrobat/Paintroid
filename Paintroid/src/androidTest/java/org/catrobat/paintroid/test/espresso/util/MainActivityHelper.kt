...
import org.catrobat.paintroid.test.espresso.util.wrappers.MainActivityImplementationExeption
...
data class MainActivityHelper(private val activity: MainActivity) {
    ...
    companion object {
        fun getMainActivityFromView(view: View): MainActivity {
            ...
            throw MainActivityImplementationExeption("View context does not implement MainActivity")
        }
    }
}
