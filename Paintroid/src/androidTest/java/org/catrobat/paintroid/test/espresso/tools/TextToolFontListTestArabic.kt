...
class TextToolFontListTestArabic {
    ...
    @Rule
    var launchActivityRule: ActivityTestRule<MainActivity> = RtlActivityTestRule(
        MainActivity::class.java, "ar"
    )
    ...
    fun testTextFontFaceOfFontSpinnerArabic() {
        Assert.assertEquals(
            View.LAYOUT_DIRECTION_RTL.toLong(),
            configuration.layoutDirection.toLong()
        )
