...
package org.catrobat.catroid.paintroid.test.espresso.tools;
...
import org.catrobat.catroid.paintroid.test.espresso.util.ActivityHelper;
import org.catrobat.catroid.paintroid.test.espresso.util.BitmapLocationProvider;
import org.catrobat.catroid.paintroid.test.espresso.util.DialogHiddenIdlingResource;
import org.catrobat.catroid.paintroid.test.espresso.util.DrawingSurfaceLocationProvider;
...
import static org.catrobat.catroid.paintroid.test.espresso.util.EspressoUtils.BROWN2_COLOR_PICKER_BUTTON_POSITION;
import static org.catrobat.catroid.paintroid.test.espresso.util.EspressoUtils.GREEN_COLOR_PICKER_BUTTON_POSITION;
import static org.catrobat.catroid.paintroid.test.espresso.util.EspressoUtils.clickSelectedToolButton;
import static org.catrobat.catroid.paintroid.test.espresso.util.EspressoUtils.getToolMemberColorTolerance;
import static org.catrobat.catroid.paintroid.test.espresso.util.EspressoUtils.openToolOptionsForCurrentTool;
import static org.catrobat.catroid.paintroid.test.espresso.util.EspressoUtils.selectColorPickerPresetSelectorColor;
import static org.catrobat.catroid.paintroid.test.espresso.util.EspressoUtils.selectTool;
import static org.catrobat.catroid.paintroid.test.espresso.util.UiInteractions.setProgress;
import static org.catrobat.catroid.paintroid.test.espresso.util.UiInteractions.swipeAccurate;
import static org.catrobat.catroid.paintroid.test.espresso.util.UiInteractions.touchAt;
import static org.catrobat.catroid.paintroid.test.espresso.util.UiMatcher.withProgress;
import static org.catrobat.catroid.paintroid.test.espresso.util.wrappers.DrawingSurfaceInteraction.onDrawingSurfaceView;
import static org.catrobat.catroid.paintroid.test.espresso.util.wrappers.ToolBarViewInteraction.onToolBarView;
import static org.catrobat.catroid.paintroid.test.espresso.util.wrappers.ToolPropertiesInteraction.onToolProperties;
import static org.catrobat.catroid.paintroid.test.espresso.util.wrappers.TopBarViewInteraction.onTopBarView;
