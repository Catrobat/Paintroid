...
class ToolControllerTest {
    ...
    @Test
    fun testToolOptionsViewControllerWhenOptionsNotVisibleReturnsFalse() { Assert.assertFalse(toolController.toolOptionsViewVisible()) }
    ...
    fun testGetToolColorReturnsColor() {
        ...
        Assert.assertEquals(Color.CYAN.toLong(), toolController.toolColor)
    }
