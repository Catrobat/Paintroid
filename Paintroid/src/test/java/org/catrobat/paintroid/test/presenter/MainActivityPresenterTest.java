...
public class MainActivityPresenterTest {
	...
	public void testHandlePermissionResultSavePermissionGranted() {
		...
		verify(interactor).saveImage(any(SaveImage.SaveImageCallback.class), eq(SAVE_IMAGE_DEFAULT), eq(workspace), eq(uri));
	}
	...
	public void testHandlePermissionResultSaveCopyPermissionGranted() {
		...
		verify(interactor).saveCopy(any(SaveImage.SaveImageCallback.class), eq(SAVE_IMAGE_DEFAULT), eq(workspace));
	}
