...
public class LayerSelectorView extends LinearLayout {
	...
	private void init() {
		...
		// };
		//
		// mSeekBarRed = (SeekBar) layView
		// .findViewById(R.id.layer_rgb_seekbar_red);
		// mSeekBarRed.setOnSeekBarChangeListener(seekBarListener);
		// mSeekBarGreen = (SeekBar) layView
		// .findViewById(R.id.layer_rgb_seekbar_green);
		// mSeekBarGreen.setOnSeekBarChangeListener(seekBarListener);
		// mSeekBarBlue = (SeekBar) layView
		// .findViewById(R.id.layer_rgb_seekbar_blue);
		// mSeekBarBlue.setOnSeekBarChangeListener(seekBarListener);
		// mSeekBarAlpha = (SeekBar) layView
		// .findViewById(R.id.layer_rgb_seekbar_alpha);
		// mSeekBarAlpha.setOnSeekBarChangeListener(seekBarListener);
		//
		// mTextViewRed = (TextView) layView.findViewById(R.id.rgb_red_value);
		// mTextViewGreen = (TextView)
		// layView.findViewById(R.id.rgb_green_value);
		// mTextViewBlue = (TextView) layView.findViewById(R.id.rgb_blue_value);
		// mTextViewAlpha = (TextView)
		// layView.findViewById(R.id.rgb_alpha_value);
		//
