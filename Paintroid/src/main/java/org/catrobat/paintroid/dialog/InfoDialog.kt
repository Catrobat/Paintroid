...
class InfoDialog : AppCompatDialogFragment(), DialogInterface.OnClickListener {
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        val builder = AlertDialog.Builder(context!!, R.style.PocketPaintAlertDialog)
    ...
    enum class DialogType(@get:DrawableRes
    ...
    companion object {
		...
		fun newInstance(dialogType: DialogType, @StringRes messageResource: Int, @StringRes titleResource: Int): InfoDialog {
            ...
            val bundle = Bundle()
            bundle.putInt(DRAWABLE_RESOURCE_KEY, dialogType.imageResource)
