...
public class PermissionFullScreenDialog extends AppCompatDialogFragment {

    private String context;
    private static String messageMember;

    public static PermissionFullScreenDialog newInstance(String context, String message) {

        PermissionFullScreenDialog permissionInfoDialog = new PermissionFullScreenDialog();
