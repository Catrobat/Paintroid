...
class AdvancedSettingsDialog : MainActivityDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val eventsizeSwitch = view.findViewById<SwitchCompat>(R.id.pocketpaint_eventsize)

        antialiasingSwitch.isChecked = antialiasing
        smoothSwitch.isChecked = smoothing
        eventsizeSwitch.isChecked = useEventSize
        ...
        eventsizeSwitch?.setOnCheckedChangeListener { _, isChecked ->
