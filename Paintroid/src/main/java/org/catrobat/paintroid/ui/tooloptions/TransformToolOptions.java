...
public class TransformToolOptions implements TransformToolOptionsContract {
	private static final String TAG = TransformToolOptions.class.getSimpleName();
	...
	public TransformToolOptions(Activity activity, ViewGroup rootView) {
		LayoutInflater inflater = LayoutInflater.from(activity);
		inflater.inflate(R.layout.dialog_pocketpaint_transform_tool, rootView);

		widthEditText = activity.findViewById(R.id.pocketpaint_transform_width_value);
		...
		heightEditText = activity.findViewById(R.id.pocketpaint_transform_height_value);
		...
		activity.findViewById(R.id.pocketpaint_transform_auto_crop_btn)
		...
		activity.findViewById(R.id.pocketpaint_transform_rotate_left_btn)
				.setOnClickListener(new View.OnClickListener() {
					@Override
					public void onClick(View v) {
		...
		activity.findViewById(R.id.pocketpaint_transform_rotate_right_btn)
				.setOnClickListener(new View.OnClickListener() {
					@Override
					public void onClick(View v) {
		...
		activity.findViewById(R.id.pocketpaint_transform_flip_horizontal_btn)
				.setOnClickListener(new View.OnClickListener() {
					@Override
					public void onClick(View v) {
		...
		activity.findViewById(R.id.pocketpaint_transform_flip_vertical_btn)
				.setOnClickListener(new View.OnClickListener() {
					@Override
					public void onClick(View v) {
