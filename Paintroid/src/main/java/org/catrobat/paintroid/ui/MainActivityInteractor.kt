...
class MainActivityInteractor : Interactor {
    ...
    override fun saveCopy(callback: SaveImageCallback, requestCode: Int, workspace: Workspace) {
        SaveImage(callback, requestCode, workspace, null, true, scopeIO).execute()
    }
    ...
    override fun saveImage(
        ...
        SaveImage(callback, requestCode, workspace, uri, false, scopeIO).execute()
    }
