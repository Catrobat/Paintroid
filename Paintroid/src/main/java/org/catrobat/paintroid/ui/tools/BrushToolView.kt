...
private const val CONSTANT_1 = 3f
private const val CONSTANT_2 = 16f
private const val CONSTANT_3 = 56f
private const val CONSTANT_4 = .25
...
class BrushToolView : View, BrushToolPreview {
    ...
    private fun drawEraserPreview(canvas: Canvas) {
        ...
        val startX = right - width / CONSTANT_1
        val startY = top + height - CONSTANT_3
        val endX = right - width / CONSTANT_2
        val endY = top + height - CONSTANT_3
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        setMeasuredDimension(widthSize, (widthSize * CONSTANT_4).toInt())
    }
