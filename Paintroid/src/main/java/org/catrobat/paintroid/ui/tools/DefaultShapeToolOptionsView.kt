...
class DefaultShapeToolOptionsView(rootView: ViewGroup) : ShapeToolOptionsView {
    ...
    init {
        ...
        outlineWidthEditText.filters = arrayOf<InputFilter>(DefaultNumberRangeFilter(MIN_VAL, MAX_VAL))
    ...
    private fun setupUI(
        ...
        outlineWidthSeekBarVisibility: Int,
        outlineWidthEditTextVisibility: Int,
        outlineViewVisibility: Int,
        outlineTextViewVisibility: Int
    ) {
        ...
        outlineWidthSeekBar.visibility = outlineWidthSeekBarVisibility
        outlineWidthEditText.visibility = outlineWidthEditTextVisibility
        outlineView.visibility = outlineViewVisibility
        outlineTextView.visibility = outlineTextViewVisibility
    }
