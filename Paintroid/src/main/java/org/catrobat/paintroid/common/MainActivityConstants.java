...
public final class MainActivityConstants {
	...
	public static final int PERMISSION_EXTERNAL_STORAGE_SAVE_CONFIRMED_NEW_IMAGE = 4;
	public static final int PERMISSION_EXTERNAL_STORAGE_SAVE_CONFIRMED_FINISH = 5;
	public static final int PERMISSION_EXTERNAL_STORAGE_SAVE_CONFIRMED_BACK_TO_PC = 6;
	public static final int PERMISSION_EXTERNAL_STORAGE_NEW_IMAGE_CAMERA = 7;
	...
	@IntDef({PERMISSION_EXTERNAL_STORAGE_LOAD, PERMISSION_EXTERNAL_STORAGE_SAVE, PERMISSION_EXTERNAL_STORAGE_SAVE_COPY,
			PERMISSION_EXTERNAL_STORAGE_NEW_IMAGE_CAMERA, PERMISSION_EXTERNAL_STORAGE_SAVE_CONFIRMED_NEW_IMAGE,
