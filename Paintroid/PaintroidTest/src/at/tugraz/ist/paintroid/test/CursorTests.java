...
public class CursorTests extends ActivityInstrumentationTestCase2<MainActivity> {
	...
	public void setUp() throws Exception {
		...
		attributeButton1 = (TextView) mainActivity.findViewById(R.id.btn_Parameter1);
		attributeButton2 = (TextView) mainActivity.findViewById(R.id.btn_Parameter2);
	...
	public void testCursorStates() throws Exception {
		...
		solo.waitForActivity("MenuTabActivity");
		solo.clickOnText(mainActivity.getResources().getString(R.string.button_cursor));
		...
		solo.clickOnView(toolButton);
		solo.waitForActivity("MenuTabActivity");
		solo.clickOnText(mainActivity.getResources().getString(R.string.button_brush));
		solo.waitForActivity("MainActivity");
		assertEquals(ToolState.INACTIVE, drawingSurface.getToolState());
	}

	public void testCursorStatesDoubleTab() throws Exception {
		// double tap
		solo.clickOnScreen(screenWidth / 2, screenHeight / 2);
		solo.drag(screenWidth / 2, screenWidth / 2 + 1, screenHeight / 2, screenHeight / 2, 50);
		solo.sleep(400);
