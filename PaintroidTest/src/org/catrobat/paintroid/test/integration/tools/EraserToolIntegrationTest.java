...
public class EraserToolIntegrationTest extends BaseIntegrationTestClass {
	...
	public void testEraseNothing() {
		...
		int colorBeforeErase = drawingSurface.getBitmapPixelColor(new PointF(xCoord, yCoord));
		assertEquals("Get transparent background color", Color.TRANSPARENT, colorBeforeErase);

		selectTool(ToolType.ERASER);
		mSolo.clickOnScreen(xCoord, yCoord);

		int colorAfterErase = drawingSurface.getBitmapPixelColor(new PointF(xCoord, yCoord));
	...
	public void testEraseAfterBrushAndThenBrushAgain() throws SecurityException, IllegalArgumentException,
		...
		int colorBeforeErase = PaintroidApplication.drawingSurface.getBitmapPixelColor(pointOnBitmap);
		...
		int colorAfterErase = PaintroidApplication.drawingSurface.getBitmapPixelColor(pointOnBitmap);
		...
		PrivateAccess.setMemberValue(BaseTool.class, PaintroidApplication.currentTool, "mBitmapPaint", strokePaint);
		mSolo.clickOnScreen(clickCoordinateX, clickCoordinateY);
		int colorAfterBrush = PaintroidApplication.drawingSurface.getBitmapPixelColor(pointOnBitmap);
