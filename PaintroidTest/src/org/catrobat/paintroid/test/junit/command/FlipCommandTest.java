...
public class FlipCommandTest extends CommandTestSetup {
	...
	public void testVerticalFlip() {
		...
		int pixel = PaintroidApplication.drawingSurface.getBitmapCopy().getPixel(mBitmapWidth - 1, mBitmapWidth / 2);
	...
	public void testHorizontalFlip() {
		...
		mCommandUnderTest.run(mCanvasUnderTest, mBitmapUnderTest);
		int pixel = PaintroidApplication.drawingSurface.getBitmapCopy().getPixel(mBitmapWidth / 2, mBitmapWidth - 1);
		assertEquals("pixel should be paint_base_color", PAINT_BASE_COLOR, pixel);
	}
